...
lazy val messagesSections = Seq(
  ...
  ColumnarSection("# Partnership",
    primaryPrefixes = Seq("partnership", "addPartnership")),
  ColumnarSection("# Company",
    primaryPrefixes = Seq("company", "addCompany")),
  ColumnarSection("# Trust",
    primaryPrefixes = Seq("trust", "addTrust")),
  ColumnarSection("# Verify",
    primaryPrefixes = Seq("verify")),
  ColumnarSection("# Contractor Details",
    primaryPrefixes = Seq("contractordetails")),
)
...
lazy val appRoutesSections = Seq(
  ...
  ColumnarSection("# Contractor Details",
    ...
    secondaryPrefixes = Seq("controllers.contractordetails.")),
)
