...
class CompanyPhoneNumberViewSpec extends AnyWordSpec with Matchers with GuiceOneAppPerSuite {

  "CompanyPhoneNumberView" should {
  ...
  trait Setup {
    ...
    val view: CompanyPhoneNumberView = app.injector.instanceOf[CompanyPhoneNumberView]
  }
}
