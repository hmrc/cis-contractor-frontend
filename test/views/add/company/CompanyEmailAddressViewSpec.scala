...
class CompanyEmailAddressViewSpec extends AnyWordSpec with Matchers with GuiceOneAppPerSuite {
  ...
  trait Setup {
    ...
    val view: CompanyEmailAddressView = app.injector.instanceOf[CompanyEmailAddressView]
  }
}
