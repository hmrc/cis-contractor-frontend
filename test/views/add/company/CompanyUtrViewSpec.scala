...
class CompanyUtrViewSpec extends AnyWordSpec with Matchers with GuiceOneAppPerSuite {

  "CompanyUtrView" should {
  ...
  trait Setup {
    ...
    val view: CompanyUtrView = app.injector.instanceOf[CompanyUtrView]
  }
}
