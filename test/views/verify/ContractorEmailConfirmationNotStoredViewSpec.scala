...
class ContractorEmailConfirmationNotStoredViewSpec extends AnyWordSpec with Matchers with GuiceOneAppPerSuite {

  "ContractorEmailConfirmationNotStoredView" should {

    "render the page with title, heading, yes/no radios and continue button" in new Setup {
  ...
  trait Setup {
    ...
    private val formProvider =
      new ContractorEmailConfirmationNotStoredFormProvider()
    ...
    val view: ContractorEmailConfirmationNotStoredView =
      app.injector.instanceOf[ContractorEmailConfirmationNotStoredView]
  }
}
