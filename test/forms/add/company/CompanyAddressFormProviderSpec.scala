...
class CompanyAddressFormProviderSpec extends StringFieldBehaviours {
  ...
  ".addressLine1" - {
    ...
    val requiredKey = "companyAddress.error.addressLine1.required"
    val lengthKey   = "companyAddress.error.addressLine1.length"
    val invalidKey  = "companyAddress.error.addressLine1.invalidCharacters"
  ...
  ".addressLine2 (optional)" - {
    ...
    val lengthKey    = "companyAddress.error.addressLine2.length"
    val invalidKey   = "companyAddress.error.addressLine2.invalidCharacters"
    val firstCharKey = "companyAddress.error.addressLine2.firstCharMustBeLetterOrNumber"
  ...
  ".addressLine3" - {
    ...
    val requiredKey  = "companyAddress.error.addressLine3.required"
    val lengthKey    = "companyAddress.error.addressLine3.length"
    val invalidKey   = "companyAddress.error.addressLine3.invalidCharacters"
    val firstCharKey = "companyAddress.error.addressLine3.firstCharMustBeLetterOrNumber"
  ...
  ".addressLine4 (optional)" - {
    ...
    val lengthKey = "companyAddress.error.addressLine4.length"
  ...
  ".postalCode" - {
    ...
    val requiredKey = "companyAddress.error.postalCode.required"
    val lengthKey   = "companyAddress.error.postalCode.length"
    val invalidKey  = "companyAddress.error.postalCode.invalid"
  ...
  ".country" - {
    ...
    val requiredKey = "companyAddress.country.error.required"
