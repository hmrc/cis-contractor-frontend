...
class ViewOnlySubcontractorControllerSpec extends SpecBase with MockitoSugar {

  private val cisId             = "INST-123"
  private val subbieResourceRef = 1001L

  private lazy val viewOnlySubcontractorRoute =
    controllers.viewOnly.routes.ViewOnlySubcontractorController
  ...
  "ViewOnlySubcontractorController" - {
    ...
    "onPageLoad" - {
      ...
      "must retrieve a company subcontractor, save populated answers and redirect to company CYA" in {
        ...
        running(application) {
          ...
          redirectLocation(result).value mustBe
            controllers.viewOnly.company.routes.ViewOnlyCompanyCheckYourAnswersController
              .onPageLoad()
              .url
      ...
      "must retrieve a partnership subcontractor, save populated answers and redirect to partnership CYA" in {
        ...
        running(application) {
          ...
          redirectLocation(result).value mustBe
            controllers.viewOnly.partnership.routes.ViewOnlyPartnershipCheckYourAnswersController
              .onPageLoad()
              .url
      ...
      "must retrieve a trust subcontractor, save populated answers and redirect to trust CYA" in {
        ...
        running(application) {
          ...
          redirectLocation(result).value mustBe
            controllers.viewOnly.trust.routes.ViewOnlyTrustCheckYourAnswersController
              .onPageLoad()
              .url
