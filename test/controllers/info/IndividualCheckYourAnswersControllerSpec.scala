...
class IndividualCheckYourAnswersControllerSpec extends SpecBase with MockitoSugar {
  ...
  "IndividualCheckYourAnswersController" - {
    ...
    "must redirect to Journey Recovery when IndividualAnswers are missing" in {
