...
import views.html.SubNationalInsuranceNumberView
...
class SubNationalInsuranceNumberControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val subNationalInsuranceNumberRoute = routes.SubNationalInsuranceNumberController.onPageLoad(NormalMode).url
