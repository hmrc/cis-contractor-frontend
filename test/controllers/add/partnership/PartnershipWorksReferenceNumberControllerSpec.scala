...
class PartnershipWorksReferenceNumberControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val partnershipWorksReferenceNumberRoute: String =
  ...
  "PartnershipWorksReferenceNumber Controller" - {
    ...
    "must redirect to yesOrNo page when yesorno page has No for a GET" in {
      ...
      val application = applicationBuilder(userAnswers =
        Some(uaWithName.set(PartnershipWorksReferenceNumberYesNoPage, false).success.value)
      ).build()
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers =
        uaWithName
          .set(PartnershipWorksReferenceNumberPage, "answer")
          .success
          .value
