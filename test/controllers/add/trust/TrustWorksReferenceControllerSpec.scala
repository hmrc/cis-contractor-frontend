...
class TrustWorksReferenceControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val trustWorksReferenceRoute: String =
  ...
  "TrustWorksReference Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = uaWithName.set(TrustWorksReferencePage, "answer").success.value
      ...
      running(application) {
        ...
        status(result) mustEqual OK
        contentAsString(result) mustEqual view(form.fill("answer"), NormalMode, trustName)(
          request,
