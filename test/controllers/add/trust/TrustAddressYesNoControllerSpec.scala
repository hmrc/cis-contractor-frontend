...
class TrustAddressYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val trustAddressYesNoRoute: String = controllers.add.trust.routes.TrustAddressYesNoController.onPageLoad(NormalMode).url

  "TrustAddressYesNo Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(TrustAddressYesNoPage, true).success.value
