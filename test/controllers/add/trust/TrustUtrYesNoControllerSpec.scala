...
class TrustUtrYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  private lazy val amendRouteLoad   = controllers.add.trust.routes.TrustUtrYesNoController.onPageLoad(AmendMode).url
  private lazy val amendRouteSubmit = controllers.add.trust.routes.TrustUtrYesNoController.onSubmit(AmendMode).url
