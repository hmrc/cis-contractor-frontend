...
import views.html.add.trust.AddTrustContactMethodsYesNoView

import scala.concurrent.Future

class AddTrustContactMethodsYesNoControllerSpec extends SpecBase with MockitoSugar {

  private val formProvider = new AddTrustContactMethodsYesNoFormProvider()
  private val form         = formProvider()

  private lazy val addTrustContactMethodsYesNoRoute =
  ...
  "AddTrustContactMethodsYesNo Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, addTrustContactMethodsYesNoRoute)

        val result = route(application, request).value

        val view = application.injector.instanceOf[AddTrustContactMethodsYesNoView]
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = uaWithName.set(AddTrustContactMethodsYesNoPage, true).success.value
    ...
    "must redirect to the TrustUtrYesNo page when valid data with value No is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, addTrustContactMethodsYesNoRoute)
    ...
    "must add AddTrustContactMethodsYesNoPage to AmendedPagesPage when submitted in AmendMode" in {
      ...
      running(application) {
        val request =
          FakeRequest(
            POST,
            controllers.add.trust.routes.AddTrustContactMethodsYesNoController
              .onSubmit(AmendMode)
              .url
        ...
        updatedAnswers
          ...
          .value must contain(AddTrustContactMethodsYesNoPage.toString)
      }
    }
    ...
    "must return a Bad Request and errors when no value is submitted" in {
      ...
      running(application) {
        ...
        val form      = new AddTrustContactMethodsYesNoFormProvider()()
        ...
        contentAsString(result) must include(messages(application)("addTrustContactMethodsYesNo.error.required"))
      }
    }
