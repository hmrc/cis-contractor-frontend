...
class SubcontractorPopulatorSpec extends SpecBase with Matchers {
  ...
  "SubcontractorPopulator.populate" - {
    ...
    "must populate IndividualAnswers for an individual subcontractor" in {
    ...
    "must populate CompanyAnswers for a limited company" in {
    ...
    "must populate PartnershipAnswers for a partnership" in {
    ...
    "must populate TrustAnswers for a trust" in {
