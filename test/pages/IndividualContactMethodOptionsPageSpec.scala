...
import models.IndividualContactMethodOptions.{Emailaddress, Mobilenumber, Phonenumber}
import pages.add.{IndividualEmailAddressPage, IndividualMobileNumberPage, IndividualPhoneNumberPage}
