...
final class SubcontractorServiceSpec extends SpecBase with MockitoSugar {
  ...
  "SubcontractorService" - {
    ...
    "createAndUpdateSubcontractor" - {
      ...
      "must send empty address fields when an amended individual address is removed" in {
        val mockConnector   = mock[ConstructionIndustrySchemeConnector]
        val service         = new SubcontractorService(mockConnector)
        val originalAddress = Address(
          addressLine1 = "old i1",
          addressLine2 = Some("old i2"),
        ...
        verify(mockConnector).createAndUpdateSubcontractor(captor.capture())(any[HeaderCarrier])

        val sent = captor.getValue.asInstanceOf[IndividualOrSoleTraderPayload]
        sent.addressLine1 mustBe Some("")
        sent.addressLine2 mustBe Some("")
        sent.city mustBe Some("")
        sent.county mustBe Some("")
        sent.postcode mustBe Some("")
        sent.country mustBe Some("")
      }

      "must send empty address fields when an amended company address is removed" in {
        val mockConnector   = mock[ConstructionIndustrySchemeConnector]
        val service         = new SubcontractorService(mockConnector)
        val originalAddress = Address(
          addressLine1 = "old c1",
          addressLine2 = Some("old c2"),
          addressLine3 = Some("old city"),
          addressLine4 = Some("old county"),
        ...
        val original = OriginalCompanyAnswers(
          companyName = None,
          addressYesNo = Some(true),
          address = Some(originalAddress),
        ...
        val sent = captor.getValue.asInstanceOf[CompanyPayload]
        sent.addressLine1 mustBe Some("")
        sent.addressLine2 mustBe Some("")
        sent.city mustBe Some("")
        sent.county mustBe Some("")
      ...
      "must send empty address fields when an amended partnership address is removed" in {
        val mockConnector   = mock[ConstructionIndustrySchemeConnector]
        val service         = new SubcontractorService(mockConnector)
        val originalAddress = Address(
          addressLine1 = "old p1",
          addressLine2 = Some("old p2"),
          addressLine3 = Some("old city"),
          addressLine4 = Some("old county"),
          postcode = Some("CC1 1CC"),
          country = Some(Country(Some("GB"), Some("United Kingdom")))
        )

        val original = OriginalPartnershipAnswers(
        ...
        val sent = captor.getValue.asInstanceOf[PartnershipPayload]
        sent.addressLine1 mustBe Some("")
        sent.addressLine2 mustBe Some("")
        sent.city mustBe Some("")
        sent.county mustBe Some("")
      ...
      "must send empty address fields when an amended trust address is removed" in {
        val mockConnector   = mock[ConstructionIndustrySchemeConnector]
        val service         = new SubcontractorService(mockConnector)
        val originalAddress = Address(
          addressLine1 = "old t1",
          addressLine2 = Some("old t2"),
          addressLine3 = Some("old city"),
          addressLine4 = Some("old county"),
          postcode = Some("DD1 1DD"),
          country = Some(Country(Some("GB"), Some("United Kingdom")))
        )

        val original = OriginalTrustAnswers(
          trustName = None,
          addressYesNo = Some(true),
          address = Some(originalAddress),
        ...
        val sent = captor.getValue.asInstanceOf[TrustPayload]
        sent.addressLine1 mustBe Some("")
        sent.addressLine2 mustBe Some("")
        sent.city mustBe Some("")
        sent.county mustBe Some("")
