...
class PartnershipUniqueTaxpayerReferenceSummarySpec extends AnyFreeSpec with Matchers {
  ...
  "PartnershipUniqueTaxpayerReferenceSummary.row" - {
    ...
    "must return a SummaryListRow when the answer exists" in {
      ...
      val maybeRow = PartnershipUniqueTaxpayerReferenceSummary.row(answers)
