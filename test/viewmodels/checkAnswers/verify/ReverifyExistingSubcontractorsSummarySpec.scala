...
class ReverifyExistingSubcontractorsSummarySpec extends AnyFreeSpec with Matchers {

  implicit val messages: Messages = stubMessages()

  "ReverifyExistingSubcontractorsSummary.row" - {

    "must return a SummaryListRow when an answer exists" in {
      ...
      val maybeRow: Option[SummaryListRow] =
        ReverifyExistingSubcontractorsSummary.row(answers)
      ...
      val expectedKeyText =
        messages("reverifyExistingSubcontractors.checkYourAnswersLabel")
      ...
      val expectedHref       =
        routes.ReverifyExistingSubcontractorsController
          .onPageLoad()
          .url
    ...
    "must return None when the answer does not exist" in {
      ...
      ReverifyExistingSubcontractorsSummary.row(answers) shouldBe None
    }
  }
}
