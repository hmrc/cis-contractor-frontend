...
class ContractorEmailConfirmationNotStoredSummarySpec extends AnyFreeSpec with Matchers {

  implicit val messages: Messages = stubMessages()

  "ContractorEmailConfirmationNotStoredSummary.row" - {
    ...
    "must return a SummaryListRow with 'Yes' when the answer is true" in {
      ...
      val maybeRow: Option[SummaryListRow] =
        ContractorEmailConfirmationNotStoredSummary.row(answers)
      ...
      val expectedHref       =
        routes.ContractorEmailConfirmationNotStoredController
    ...
    "must return None when the answer does not exist" in {
      ...
      ContractorEmailConfirmationNotStoredSummary.row(answers) shouldBe None
    }
  }
}
