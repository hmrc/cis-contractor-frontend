...
import models.insufficient.{InsufficientSubcontractorDetailsUpdated, InsufficientSubcontractorUpdate}
import play.api.i18n.Messages
import uk.gov.hmrc.govukfrontend.views.viewmodels.content.Text
import uk.gov.hmrc.govukfrontend.views.viewmodels.table.TableRow

object InsufficientSubcontractorDetailsUpdatedViewModel {

  def rows(
    confirmationData: InsufficientSubcontractorDetailsUpdated
  ...
  private def row(
    update: InsufficientSubcontractorUpdate
