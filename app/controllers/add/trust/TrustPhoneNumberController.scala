...
class TrustPhoneNumberController @Inject() (
  ...
  formProvider: TrustPhoneNumberFormProvider,
        ...
        .map { trustName =>
          form
            ...
            .fold(
              ...
              value =>
                for {
                  updatedAnswers <- Future.fromTry(request.userAnswers.set(TrustPhoneNumberPage, value))
