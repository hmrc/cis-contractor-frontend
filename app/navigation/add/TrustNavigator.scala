...
class TrustNavigator @Inject() () extends NavigatorForJourney {
  ...
  private val normalRoutes: Page => UserAnswers => Call = {
    ...
    case TrustUtrYesNoPage     => navigatorFromTrustUtrYesNoPage(NormalMode)
  ...
  private val checkRouteMap: Page => UserAnswers => Call = {
    ...
    case TrustUtrYesNoPage     => navigatorFromTrustUtrYesNoPage(CheckMode)
  ...
  private def navigatorFromTrustUtrYesNoPage(mode: Mode)(ua: UserAnswers): Call =
    (ua.get(TrustUtrYesNoPage), mode) match {
      ...
      case (Some(false), CheckMode)  => controllers.add.trust.routes.TrustCheckYourAnswersController.onPageLoad()
