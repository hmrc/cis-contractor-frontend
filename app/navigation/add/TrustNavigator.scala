...
class TrustNavigator @Inject() () extends NavigatorForJourney {
  ...
  private val normalRoutes: Page => UserAnswers => Call = {
    case TrustAddressYesNoPage => _ => controllers.add.trust.routes.TrustAddressYesNoController.onPageLoad(NormalMode)
    case _                     => _ => routes.IndexController.onPageLoad()
  }

  private val checkRouteMap: Page => UserAnswers => Call = {
    case TrustAddressYesNoPage => _ => controllers.add.trust.routes.TrustAddressYesNoController.onPageLoad(CheckMode)
