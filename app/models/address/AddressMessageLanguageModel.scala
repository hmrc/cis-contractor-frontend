...
object LookupPageMessagesModel {
  ...
  def forJourney(journeyId: String, lang: Lang, msgPrefix: Option[String] = None, optName: Option[String] = None)(
...
object CountryPickerMessagesModel {
  ...
  def forJourney(journeyId: String, lang: Lang, optName: Option[String] = None)(implicit
