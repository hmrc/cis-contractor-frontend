...
object AddressMessagesModel {
  ...
  def forJourney(journeyId: String, lang: Lang, useUkMode: Boolean = false, optName: Option[String] = None)(implicit
    ...
    AddressMessagesModel(
      ...
      countryPickerLabels =
        if (useUkMode) None else Some(CountryPickerMessagesModel.forJourney(journeyId, lang, optName)),
