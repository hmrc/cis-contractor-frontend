...
object FinalValidationFieldMapper {
  ...
  def fromValidationField(
    ...
    field match {
      ...
      case SubcontractorValidationField.TradingName =>
        FinalValidationField.TradingName

      case SubcontractorValidationField.PartnershipTradingName =>
        FinalValidationField.PartnershipTradingName

      case SubcontractorValidationField.Utr =>
        FinalValidationField.Utr

      case SubcontractorValidationField.PartnerUtr =>
        FinalValidationField.PartnerUtr

      case SubcontractorValidationField.Crn =>
        FinalValidationField.Crn

      case SubcontractorValidationField.FirstName =>
        FinalValidationField.FirstName

      case SubcontractorValidationField.SecondName =>
        FinalValidationField.SecondName

      case SubcontractorValidationField.Surname =>
        FinalValidationField.Surname

      case SubcontractorValidationField.Nino =>
      ...
      case SubcontractorValidationField.AddressLine2 =>
        FinalValidationField.AddressLine2

      case SubcontractorValidationField.AddressLine3 =>
        FinalValidationField.AddressLine3

      case SubcontractorValidationField.AddressLine4 =>
        FinalValidationField.AddressLine4

      case SubcontractorValidationField.Country =>
        FinalValidationField.Country

      case SubcontractorValidationField.Postcode =>
        FinalValidationField.PostCode

      case SubcontractorValidationField.EmailAddress =>
        FinalValidationField.EmailAddress

      case SubcontractorValidationField.PhoneNumber =>
        FinalValidationField.PhoneNumber

      case SubcontractorValidationField.MobilePhoneNumber =>
