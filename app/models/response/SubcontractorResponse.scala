...
case class SubcontractorResponse(
...
object SubcontractorResponse:
  given reads: Reads[SubcontractorResponse]   = Json.reads[SubcontractorResponse]
  given writes: Writes[SubcontractorResponse] = s =>
    Json
      .writes[SubcontractorResponse]
