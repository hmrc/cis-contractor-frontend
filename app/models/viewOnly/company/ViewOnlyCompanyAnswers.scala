...
package models.viewOnly.company
...
case class ViewOnlyCompanyAnswers(
...
object ViewOnlyCompanyAnswers extends models.Enumerable.Implicits {
  implicit val format: OFormat[ViewOnlyCompanyAnswers] =
    Json.format[ViewOnlyCompanyAnswers]
}
