...
case class ViewOnlyIndividualAnswers(
...
object ViewOnlyIndividualAnswers {
  implicit val format: OFormat[ViewOnlyIndividualAnswers] =
    Json.format[ViewOnlyIndividualAnswers]
}
