...
case class ViewOnlyTrustAnswers(
...
object ViewOnlyTrustAnswers extends models.Enumerable.Implicits {
  implicit val format: OFormat[ViewOnlyTrustAnswers] =
    Json.format[ViewOnlyTrustAnswers]
}
