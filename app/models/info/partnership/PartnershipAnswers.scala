...
package models.info.partnership
...
object PartnershipAnswers extends models.Enumerable.Implicits {
  implicit val format: OFormat[PartnershipAnswers] =
    Json.format[PartnershipAnswers]
}
